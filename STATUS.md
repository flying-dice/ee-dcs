...
- Now: The Caucasus OSM export is a 350 KB static gzip asset containing 10,533 active-area candidates. Site polygons take precedence over same-kind component buildings, while all 8,227 active-area industrial polygons remain. The [GitHub Pages workflow review](boards/project-backlog/23-review-pages-deployment.md) tightened paired-asset checks and deployment triggers.
...
- Working state: 2026-09-21 22:53 BST, branch `feat/ts-port-validated-lua-removed`. The old uncompressed OSM asset was removed after round-trip verification. The OSM pipeline and Pages follow-up are locally committed without a push.
