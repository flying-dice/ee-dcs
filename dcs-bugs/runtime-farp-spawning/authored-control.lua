-- Run as Mission Editor DO SCRIPT FILE in the supplied empty-FARP mission.
...
local name = _G.__issue3_authored_case_name or "Issue3-EmptyAuthored-AH64"
...
assert(#base:getParking(true) == 4, "authored FARP is not empty")
